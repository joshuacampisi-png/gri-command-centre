...
// reference interval printed on her actual pathology report. This is a
// convenience default, not medical advice.
//
// Each marker: { id, name, category, unit, low, high, optimalLow?, optimalHigh?,
//                higherIsBetter?, cycleDependent?, desc }
...
export const MARKERS = [
  ...
  // Hormones (many are cycle-dependent — flag rather than hard-fail)
...
// Returns one of: 'low' | 'high' | 'optimal' | 'in' | 'unknown'
export function evaluate(marker, value) {
  ...
  // Within standard range — is it within the tighter optimal band?
