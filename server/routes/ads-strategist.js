  ...
  try {
    ...
    try {
      ...
      if (shopifyRange.ok && shopifyRange.orderDetails) {
        ...
        const fovCac = calculateFOVCAC(stats.avgFirstOrderAov || shopifyRange.revenue / shopifyRange.orders, GRI_ADS.grossMarginPct, ncac)
        const costOfDelivery = calculateCostOfDelivery(shopifyRange.revenue, shopifyRange.shipping, shopifyRange.orders, GRI_ADS.grossMarginPct)
